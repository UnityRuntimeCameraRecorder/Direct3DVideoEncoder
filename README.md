...
Used by [UnityRuntimeCameraRecorder](https://github.com/CineCapture/UnityRuntimeCameraRecorder) for GPU video encoding. The DLL itself does not depend on Unity or FFmpeg.
...
For Unity integration and camera/audio/MP4 recording, use [UnityRuntimeCameraRecorder](https://github.com/CineCapture/UnityRuntimeCameraRecorder).
